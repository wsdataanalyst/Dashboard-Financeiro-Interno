...
def criar_usuarios_iniciais():
    usuarios = [
        ("Edvanison Muniz", "edvanison@empresa.com", "@E1d2v3a4h", "admin"),
        ("Jane Xavier", "jane@empresa.com", "@J1a2n3e4", "assistente"),
        ("Renata Kelly", "renata@empresa.com", "@R1e2n3a4t5a6", "assistente")
    ]
    with get_connection() as conn:
